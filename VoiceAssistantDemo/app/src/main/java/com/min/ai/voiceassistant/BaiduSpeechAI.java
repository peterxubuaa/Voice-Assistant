...
import com.min.ai.voiceassistant.speech.Recognizer;
import com.min.ai.voiceassistant.speech.listener.IRecogListener;
import com.min.ai.voiceassistant.speech.listener.MessageStatusRecogListener;
...
import static com.min.ai.voiceassistant.speech.IStatus.*;
...
class BaiduSpeechAI {
    ...
    BaiduSpeechAI(Context context, onSpeechListener listener) {
        mContext = context;
        mListener = listener;
    }
...
//                STATUS_FINISHED 获得最终识别结果
    ...
    //开始录音，点击“开始”按钮后调用。
    void startBaiduSpeechRecognize() {
