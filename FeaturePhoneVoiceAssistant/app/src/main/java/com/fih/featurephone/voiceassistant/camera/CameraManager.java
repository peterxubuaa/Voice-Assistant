...
//            List<Integer> previewFormatList = params.getSupportedPreviewFormats();
//            int previewFormat = params.getPreviewFormat(); //default ImageFormat.NV21
//            List<Integer> pictureFormatList = params.getSupportedPictureFormats(); //only support ImageFormat.JPEG
//            int pictureFormat = params.getPictureFormat(); //default ImageFormat.JPEG
            //4.设置flash
