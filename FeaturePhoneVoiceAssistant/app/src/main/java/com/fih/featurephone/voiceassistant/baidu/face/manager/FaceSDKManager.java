package com.fih.featurephone.voiceassistant.baidu.face.manager;
...
import com.fih.featurephone.voiceassistant.baidu.face.callback.FaceDetectCallBack;
import com.fih.featurephone.voiceassistant.baidu.face.callback.FaceFeatureCallBack;
...
import com.fih.featurephone.voiceassistant.baidu.face.model.GlobalSet;
import com.fih.featurephone.voiceassistant.baidu.face.model.LivenessModel;
import com.fih.featurephone.voiceassistant.baidu.face.model.SingleBaseConfig;
...
import static com.fih.featurephone.voiceassistant.baidu.face.model.GlobalSet.FEATURE_SIZE;
import static com.fih.featurephone.voiceassistant.baidu.face.model.GlobalSet.TIME_TAG;
...
public class FaceSDKManager {
    ...
    public void onDetectCheck(final byte[] rgbData,
        ...
        mFaceDetectTaskFuture = mFaceDetectExecutorService.submit(new Runnable() {
            @Override
            public void run() {
                faceDataDetect(rgbData, srcWidth, srcHeight, faceDetectCallBack);
            }
        });
    }
    ...
    public void updateImageIntoDBManager(final Bitmap bitmap, final User user, final UserInfoUpdateListener listener) {
        ...
        mDBTaskFuture = mDBExecutorService.submit(new Runnable() {
            ...
            public void run() {
                ...
                float ret;
                // 检测人脸，提取人脸特征值
                ret = FaceSDKManager.getInstance().getFeature(bitmap, feature);
                if (ret == -1) {
