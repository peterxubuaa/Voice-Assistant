package com.fih.featurephone.voiceassistant.baidu.tts.control;
...
import com.fih.featurephone.voiceassistant.baidu.tts.MainHandlerConstant;
...
public class MySyntherizer implements MainHandlerConstant {
    ...
    void sendToUiThread(String message) {
