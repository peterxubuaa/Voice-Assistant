...
public class ParseJson {
    ...
    public static class Base_Response_Schema_Slots {
        Double mConfidence;
        public String mName;
    ...
    static protected Base_Response_Schema parseSchema(JSONObject jsonObject) {
    ...
    static protected ArrayList<Base_Response_Schema_Slots> parseSlots(JSONArray jsonArray) {
    ...
    public static class SimpleResponseAction {
        ...
        public String mIntent; //response_list -> schema -> intent
    ...
    static protected Base_Response_Action_RefineDetail parseRefineDetail(JSONObject jsonObject) {
        if (null == jsonObject) return null;
    ...
    static protected Base_Response_QuRes parseQuRes(JSONObject jsonObject) {
        if (null == jsonObject) return null;
    ...
    static protected ArrayList<Base_Response_Action> parseActionList(JSONArray jsonArray) {
        if (null == jsonArray) return null;
