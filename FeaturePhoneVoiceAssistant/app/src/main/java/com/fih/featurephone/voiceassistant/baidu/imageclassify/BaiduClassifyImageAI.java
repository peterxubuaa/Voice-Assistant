...
import com.fih.featurephone.voiceassistant.baidu.imageclassify.model.ClassifyAdvancedGeneral;
import com.fih.featurephone.voiceassistant.baidu.imageclassify.model.ClassifyAnimalPlant;
import com.fih.featurephone.voiceassistant.baidu.imageclassify.model.ClassifyCar;
import com.fih.featurephone.voiceassistant.baidu.imageclassify.model.ClassifyCurrency;
import com.fih.featurephone.voiceassistant.baidu.imageclassify.model.ClassifyDish;
import com.fih.featurephone.voiceassistant.baidu.imageclassify.model.ClassifyIngredient;
import com.fih.featurephone.voiceassistant.baidu.imageclassify.model.ClassifyLandMark;
import com.fih.featurephone.voiceassistant.baidu.imageclassify.model.ClassifyLogo;
import com.fih.featurephone.voiceassistant.baidu.imageclassify.model.ClassifyRedWine;
...
//    public static final int CLASSIFY_IMAGE_ACTION = 3;
...
//    final int CLASSIFY_TYPE_VEHICLE_DAMAGE = 11;
    ...
    public void onClassifyImageThread(final int type, final String imageFilePath, final boolean question) {
        new Thread() {
            @Override
            public void run() {
