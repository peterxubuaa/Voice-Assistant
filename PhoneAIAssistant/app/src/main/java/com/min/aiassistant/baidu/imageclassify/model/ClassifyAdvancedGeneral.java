...
import com.min.aiassistant.baidu.imageclassify.parsejson.ParseAdvancedGeneralJson;

public class ClassifyAdvancedGeneral extends BaiduImageBaseModel<ParseAdvancedGeneralJson.AdvancedGeneral> {
