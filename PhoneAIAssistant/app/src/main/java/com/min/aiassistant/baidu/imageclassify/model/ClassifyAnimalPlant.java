...
import com.min.aiassistant.baidu.imageclassify.parsejson.ParseAnimalPlantJson;

public class ClassifyAnimalPlant extends BaiduImageBaseModel<ParseAnimalPlantJson.AnimalPlant> {
