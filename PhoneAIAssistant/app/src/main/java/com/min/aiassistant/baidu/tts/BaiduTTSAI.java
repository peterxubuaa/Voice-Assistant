package com.min.aiassistant.baidu.tts;
...
import com.min.aiassistant.baidu.tts.control.InitConfig;
import com.min.aiassistant.baidu.tts.control.MySyntherizer;
import com.min.aiassistant.baidu.tts.control.NonBlockSyntherizer;
import com.min.aiassistant.baidu.tts.listener.UiMessageListener;
...
public class BaiduTTSAI {
    public static final int BAIDU_TTS_LADY = 0;
    public static final int BAIDU_TTS_GENTLEMAN = 1;
    public static final int BAIDU_TTS_GIRL = 4;
    public static final int BAIDU_TTS_BOY = 110;
    ...
    private int mTTSVoiceType = BAIDU_TTS_LADY;
    ...
    static class BaiduTTSHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            int what = msg.what;
            switch (what) {
                case com.min.aiassistant.baidu.tts.MainHandlerConstant.PRINT:
                    ...
                    break;
                case com.min.aiassistant.baidu.tts.MainHandlerConstant.UI_CHANGE_INPUT_TEXT_SELECTION:
                    Log.d(TAG, "tts playing progress = " + msg.arg1);
                    break;
                case com.min.aiassistant.baidu.tts.MainHandlerConstant.UI_CHANGE_SYNTHES_TEXT_SELECTION:
                    Log.d(TAG, "tts synthesizing progress = " + msg.arg1);
                    break;
                case com.min.aiassistant.baidu.tts.MainHandlerConstant.UI_CHANGE_TTS_START:
                    mTheBaiduTTSAI.get().mWorkState |= TTS_START_STOP_MASK;
                    mTheBaiduTTSAI.get().mListener.onStart();
                    break;
                case com.min.aiassistant.baidu.tts.MainHandlerConstant.UI_CHANGE_TTS_END:
                    mTheBaiduTTSAI.get().mWorkState &= ~TTS_START_STOP_MASK;
                    mTheBaiduTTSAI.get().mListener.onEnd();
                    break;
                case com.min.aiassistant.baidu.tts.MainHandlerConstant.INIT_SUCCESS:
    ...
    public void initBaiduTTS() {
        ...
        InitConfig initConfig = new InitConfig(BaiduBaseModel.ALL_APP_ID, BaiduBaseModel.ALL_API_KEY, BaiduBaseModel.ALL_SECRET_KEY,
    ...
    public void setTTSVoiceType(int type) {
        mTTSVoiceType = type;
    }
...
//        final int BAIDU_TTS_SPEAKER = 0; //0: 标准女声; 1:标准男声; 3: 情感男声; 4:情感女童声; 5:情感女声; 103；106；110: 情感男童声；111
        ...
        params.put(SpeechSynthesizer.PARAM_SPEAKER, String.valueOf(mTTSVoiceType));
        // 设置合成的音量，0-9 ，默认 5
