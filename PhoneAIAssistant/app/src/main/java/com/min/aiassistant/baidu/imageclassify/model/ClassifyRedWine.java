...
import com.min.aiassistant.baidu.imageclassify.parsejson.ParseRedWineJson;

public class ClassifyRedWine extends BaiduImageBaseModel<ParseRedWineJson.RedWine> {
