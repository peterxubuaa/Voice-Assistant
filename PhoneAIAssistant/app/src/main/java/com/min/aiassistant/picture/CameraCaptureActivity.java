...
public class CameraCaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private com.min.aiassistant.picture.RectFinderView mFinderView;
    ...
    private void initTouchScreenView() {
        ...
        mFinderView.init(mCameraViewSize, new Rect(0, 0, mCameraViewSize.x, mCameraViewSize.y), false);
    ...
    RectFinderView.IClickCallBack mClickCallBack = new RectFinderView.IClickCallBack() {
